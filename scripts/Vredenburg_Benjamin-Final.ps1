...
# than 7 names Vredenburg_Benjamin-hardgems.csv
$gems | Where-Object{+($_.Hardness) -gt 7} | ForEach-Object {$_.Hardness = +$_.Hardness;$_} | Export-Csv Vredeburg_Benjamin-hardgems.csv
...
# Create a file named Vredenburg_Benjamin-words.txt that contains a list of 
# unique words sorted in alphabetical order. Save it in the current directory.
$Unique | Out-File Vredenburg_Benjamin-words.txt